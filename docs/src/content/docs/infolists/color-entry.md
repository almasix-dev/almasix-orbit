...
`ColorEntry` renders a small swatch (`or-color-swatch`) beside the hex / CSS color string. Empty state uses `.placeholder(...)` instead of inventing `#000000` for display when a placeholder is set.
