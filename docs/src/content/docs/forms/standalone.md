...
A `Form` is just a schema with validation and HTML. Mount it on a custom [Page](/pages/), a Conduit component, or a plain view handler.
...
When you *do* have a model, prefer a [Resource](/resources/) so navigation, permissions, and table/form/infolist stay in one place.

Next: [Closures](/forms/closures/) · [Field reference](/forms/fields/text-input/).
