/**
 * Capture query-builder gallery shots (light + dark).
 * Usage: node docs/scripts/capture-query-builder.mjs
 */
...
const IDS = [
  ...
  "query-builder/overview/constraints",
  "query-builder/overview/rules",
  "query-builder/overview/or-logic",
  "query-builder/overview/table-filter",
];
