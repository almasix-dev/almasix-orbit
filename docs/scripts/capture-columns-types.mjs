/**
 * Capture column-type gallery shots (light + dark) for the tables/columns/*.md docs.
 * Usage: node docs/scripts/capture-columns-types.mjs
 */
...
const IDS = [
  // New column-type shots
  "tables/text-formatting",
  "tables/text-icons",
  "tables/icon-colors",
  "tables/image-stacked",
  "tables/select-column",
  "tables/toggle-column",
  "tables/text-input-column",
  "tables/checkbox-column",
  "tables/badge-column",
  "tables/boolean-column",
  "tables/tags-column",
  "tables/view-column",
  // Existing shots referenced by the same docs pages — recaptured to stay in sync
  "tables/money",
  "tables/text-features",
  "tables/icon-boolean",
  "tables/image-color",
  "tables/editable",
  "tables/tags-view",
