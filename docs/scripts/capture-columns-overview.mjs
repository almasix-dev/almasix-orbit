/**
 * Capture columns overview gallery shots (light + dark).
 * Usage: node docs/scripts/capture-columns-overview.mjs
 */
...
const IDS = ["tables/columns-overview", "tables/columns-overview-manager"];
