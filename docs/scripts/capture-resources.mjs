/**
 * Capture resources gallery shots (light + dark).
 * Usage: node docs/scripts/capture-resources.mjs
 */
...
const IDS = [
  "resources/view-record",
  "resources/relation-manager",
  "resources/global-search",
  "resources/soft-deletes",
];
